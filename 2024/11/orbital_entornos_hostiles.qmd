...
constante, que en gran parte tiene que ver con esl desconocimiento y otras con la maldad. 
...
como R, pero en la base de datos. Esto hace ya tiempo qu está solucionando gracias a cosas como
...
para obtener predicciones. En estos casos salvo que estemos en cosas como spark y similar lo que se
suele hacer es bajar los datos de la BD, usar el modelo, obtener predicciones y subir los resultados 
a la BD. A veces es un proceso batch o un docker o similar, pero básicamente es eso. 
...
podemos predecir en la bd

investigar a ver como lo ha convertido a sql
