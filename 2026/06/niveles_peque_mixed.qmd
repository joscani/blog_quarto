...
Lo interesante es que al meter el municipio , no sólo explica su propia varianza, sino que que cambia las estimaciones de los niveles superiores.

## El ejemplo

A ver si soy capaza de ocntarlo de forma que se entienda. 
...
Pero tiene **solo 3 municipios** muy dispares entre sí, con media global de −10, lo que hace que la media bruta de la provincia sea −13.
...
por lo que todas las observaciones de la misma provincia son como pseudoréplicas. Para la provincia 
heterogénea con 3 muncipios el modelo solo sabe que tiene 60 observaciones (3 x 20) y que son de la misma
provincia. 
...
cada municipio es de su padre y de su madre, y aunque ve datos dispersos piensa que esa variabilidad es sólo a nivl de provincia, cuando tiene
