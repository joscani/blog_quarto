...
Metes los municipios. La estimación de esa provincia se modera drásticamente. ¿Por qué?
...
- **Sin municipios**: `prov_het` aparece con media −13, muy lejos de la media nacional. El modelo interpreta eso como señal real del nivel provincia y estima $\sigma^2_{\text{prov}}$ grande. Con $\sigma^2_{\text{prov}}$ grande, el factor de shrinkage es alto y los BLUPs se contraen poco — `prov_het` se queda cerca de −13.
