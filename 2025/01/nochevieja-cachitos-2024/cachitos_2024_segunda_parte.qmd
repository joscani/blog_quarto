---
title: Cachitos 2024. Segunda parte
date: '2025-01-04'
categories: 
  - estadística
  - polémica
...
anterior](https://muestrear-no-es-pecado.es/2025/01/nochevieja-cachitos-2024/cachitos_2024_primera_parte)
...
[enlace
directorio](https://drive.google.com/drive/folders/1ACQKQ0OCbSY9Wvn5sEyOkGRHHYaAeJkd?usp=drive_link)
...
Tenemos 769 rótulos de los cuales la mayoría estarán vacíos
...
image_read(str_glue("{directorio_imagenes}00000441.jpg"))

```

```{r}
image_read(str_glue("{directorio_imagenes}00000246.jpg"))
```
